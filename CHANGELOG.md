...
### Released
- Published **classroom-ai-aup-spec** as a public, portfolio-grade education operations system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **classroom-ai-aup-spec**.
- Standardized the core objects, decision surfaces, and operator outputs around the repo's main working problem.
- Established the first reviewable version of the architecture described as: Open JSON spec for machine-readable district / school / course AI Acceptable Use Policies. The third leg of the EdTech trio (with AI Tutor Cards and Student AI Disclosure). Part of the Kinetic Gain Protocol Suite.
...
- That insight became the basis for **classroom-ai-aup-spec**.
